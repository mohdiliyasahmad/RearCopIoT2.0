...
[string] $tfsCollectionPath = "http://tfs.lcdev.net:8080/tfs"
[string] $locationToSearch = "$/Physician EMR/Development/SocialServices_09152016"
[string] $outputFile = "c:\TFS\ChangesToTFS.txt"
[string] $dateRange = "D2016-07-01 00:00:00Z~"
